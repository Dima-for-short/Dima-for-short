...
*Долгое время работал инженером по наладке и испытаниям, но в один момент понял, что хочу больше работать с данными. Сейчас аналитика – это моя любовь. Мне очень нравится находить инсайты и увеличивать прибыль компании, анализируя имеющиеся цифры. На сегодняшний день продолжаю тренировать навык в таких инструментах как: SQL, PYTHON, Power BI, Google sheets, Excel.
